...
| [0024](decisions/0024-make-the-shapes-copyable-and-the-questions-answerable.md) | The upstream entry's shape as bytes in every guide, questions to the owner as numbered options with any other reply restated first, and record filenames capped at seventy-two characters from that commit on |
...
| [0041](decisions/0041-dispose-of-the-upstream-entry-of-2026-09-24-on-the-spelling-advisory-s-ignore-list.md) | The entry from three client-style projects at 66ba9f5, kept; a project's spelling terms live in its own `.codespellignore`, which every docs audit and the root workflow read, in place of a constant a project could not write to |
