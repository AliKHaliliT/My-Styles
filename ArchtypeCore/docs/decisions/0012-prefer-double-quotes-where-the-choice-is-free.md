# 0012. Prefer double quotes where the choice is free
...
Enforcement rides the Lint verb where a checker exists. Here ruff's Q rules carry it, selected beside the docstring-presence codes; both Python styles pass untouched because the trees were already uniform.
