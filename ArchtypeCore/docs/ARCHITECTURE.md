...
- A service with full docstrings: `app/services/access/user_service.py`.
- An API translator pair: `app/api/v1/translators/users/api_to_domain.py` and `app/api/v1/translators/users/domain_to_api.py`.
