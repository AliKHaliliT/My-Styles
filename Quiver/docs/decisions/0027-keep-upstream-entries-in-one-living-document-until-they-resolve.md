# 0027. Keep upstream entries in one living document until they resolve
...
In this host each arrow carries its own file under its own docs and the host
carries one for the inquiry layer; nothing is bundled and nothing filed twice.
